  ...
  if (err) {
    ...
    throw err;
      ...
      db.serialize(function() {
        ...
        // Create user data
        const userInsert = "INSERT INTO User (userID, firstName, lastName, email, role) VALUES (?,?,?,?,?)";
        const users = [
        ...
        const applicantInsert = "INSERT INTO Applicant (userID, degree, year, isEnrolled, GPA, hasVisa, inAuckland, academicRecord, applicantAccess) VALUES (?,?,?,?,?,?,?,?,?)";
        const applicants = [
        ...
        const markerCoordinatorInsert = "INSERT INTO MarkerCoordinator (userID, markerCoordinatorAccess) VALUES (?,?)";
        const markerCoordinators = [
        ...
        const courseCoordinatorInsert = "INSERT INTO CourseCoordinator (userID, courseCoordinatorAccess) VALUES (?,?)";
        ...
        // Create course data
        const courseInsert = "INSERT INTO Course (courseID, courseName, enrolmentEstimate, enrolmentFinal, workload, coordinatorID, courseInfoDeadline, applicationDeadline, markerPrefDeadline, markerAssignmentDeadline, otherTasks) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
        const courses = [
        ...
        const applicationInsert = "INSERT INTO Application (applicationID, applicantID, courseID, CV, relevantExperience) VALUES (?,?,?,?,?)";
        const applications = [
        ...
        const markerAssignmentInsert = "INSERT INTO MarkerAssignment (markerID, courseID, year, semester, suitableForCourse) VALUES (?,?,?,?,?)";
